  ...
  return (
    <>
      <section className='flex flex-col items-center justify-center px-5 mb-20 mt-20 md:mb-24'>
        <h1 className='text-3xl text-center font-bold  md:text-4xl'>Take delight in the Lord, and he will give you the desires of your heart.</h1>
        <p className='mt-5 text-xl'>- Psalm 37:4</p>
      </section>
      ...
      <Story>
        ...
        <Paragraph>
          &quot;For using the word <i>impossible</i>. We Joneses believe in miracles and wishes. Why don&apos;t we help Macie make a wish? Let&apos;s go to the tree.&quot;
        </Paragraph>
        ...
        <Paragraph>
          <i>I&apos;m glad they&apos;re back. Why did she wear her nice shoes? She must have gone to an important meeting.</i> Marie ignored her curiosity and instructed her sisters, &quot;Now, repeat after me, star high, star bright.&quot;
        </Paragraph>
        ...
        <Paragraph>
          <i>They&apos;re happy. I wonder what great news they must tell us.</i>
        </Paragraph>
        ...
        <Paragraph>
          Closing the screen door Marie looked back at the Maple tree then gazed to the sky. <i>Lord, Mom is right, you&apos;re the true miracle worker and wish maker. You tickle me with your goodness. Thank you for granting our desires. Help me to always delight in you.</i>
        </Paragraph>
      </Story>
    </>
  );
